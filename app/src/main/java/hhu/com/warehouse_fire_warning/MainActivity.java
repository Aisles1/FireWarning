...
public class MainActivity extends Activity {
    ...
    private void bindView() {
        ...
        smoke_tv = findViewById(R.id.smoke_tv);
        warnCount_tv = findViewById(R.id.warnCount);
    ...
    private void showSettingPopwindow() {
        ...
        temHumIp_et = view.findViewById(R.id.temHumIp_et);
        temHumPort_et = view.findViewById(R.id.temHumPort_et);
        smokeIp_et = view.findViewById(R.id.smokeIp_et);
        smokePort_et = view.findViewById(R.id.smokePort_et);
        fanIp_et = view.findViewById(R.id.fanIp_et);
        fanPort_et = view.findViewById(R.id.fanPort_et);

        temMaxLim_et = view.findViewById(R.id.temMaxLim_et);
        humMinLim_et = view.findViewById(R.id.humMinLim_et);
        smokeMaxLim_et = view.findViewById(R.id.smokeMaxLim_et);
